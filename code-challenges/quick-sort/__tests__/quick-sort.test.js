...
describe('Testing the merge sort algorithm', () => {
  it('should sort an array', () => {
    expect(quickSort([8, 4, 23, 42, 16, 15])).toStrictEqual([
      4,
      8,
      15,
      16,
  ...
  it('should sort a reserve sorted array', () => {
    expect(quickSort([20, 18, 12, 8, 5, -2])).toStrictEqual([
      -2,
      5,
      8,
      12,
  ...
  it('should sort a few unique array', () => {
